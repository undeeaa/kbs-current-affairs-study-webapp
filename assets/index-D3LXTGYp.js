(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))s(n);new MutationObserver(n=>{for(const i of n)if(i.type==="childList")for(const o of i.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&s(o)}).observe(document,{childList:!0,subtree:!0});function e(n){const i={};return n.integrity&&(i.integrity=n.integrity),n.referrerPolicy&&(i.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?i.credentials="include":n.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function s(n){if(n.ep)return;n.ep=!0;const i=e(n);fetch(n.href,i)}})();class u extends Error{constructor(t,e="UNKNOWN",s=!1){super(t),this.code=e,this.retryable=s}}class S{constructor(t){this.baseUrl=t}ensureConfigured(){if(!this.baseUrl)throw new u("앱 연결 주소가 아직 설정되지 않았어요.","NOT_CONFIGURED")}async parse(t){let e;try{e=await t.json()}catch{throw new u("연결 응답을 확인하지 못했어요.","INVALID_RESPONSE",!0)}if(!e.ok||e.data===void 0)throw new u(e.error?.message??"요청을 처리하지 못했어요.",e.error?.code,e.error?.retryable);return e.data}async get(t,e={}){this.ensureConfigured();const s=new URL(this.baseUrl);s.searchParams.set("action",t),s.searchParams.set("ts",String(Date.now())),Object.entries(e).forEach(([i,o])=>o&&s.searchParams.set(i,o));const n=await fetch(s,{cache:"no-store",redirect:"follow"});return this.parse(n)}async post(t,e){this.ensureConfigured();const s=await fetch(this.baseUrl,{method:"POST",redirect:"follow",headers:{"Content-Type":"text/plain;charset=UTF-8"},body:JSON.stringify({action:t,...e})});return this.parse(s)}bootstrap(t=""){return this.get("bootstrap",{participantId:t})}history(){return this.get("history")}roundDetail(t){return this.get("roundDetail",{roundId:t})}attemptResult(t,e,s){return this.get("attemptResult",{roundId:t,participantId:e,attempt:String(s)})}submitAttempt(t){return this.post("submitAttempt",t)}adminLogin(t){return this.post("adminLogin",{code:t})}transition(t,e,s){return this.post("transition",{roundId:t,targetStatus:e,adminToken:s})}createNextRound(t,e){return this.post("createNextRound",{title:t,adminToken:e})}}function R(r){let t=2166136261;for(let e=0;e<r.length;e+=1)t^=r.charCodeAt(e),t=Math.imul(t,16777619);return t>>>0}function T(r){let t=r;return()=>{t+=1831565813;let e=t;return e=Math.imul(e^e>>>15,e|1),e^=e+Math.imul(e^e>>>7,e|61),((e^e>>>14)>>>0)/4294967296}}function v(r,t){const e=[...r],s=T(R(t));for(let n=e.length-1;n>0;n-=1){const i=Math.floor(s()*(n+1));[e[n],e[i]]=[e[i],e[n]]}return e}function E(r,t,e){const s=new Set(r.map(i=>i.questionId));if(e?.length===r.length&&e.every(i=>s.has(i))){const i=new Map(r.map(o=>[o.questionId,o]));return{questions:e.map(o=>i.get(o)),order:e}}const n=v(r,t);return{questions:n,order:n.map(i=>i.questionId)}}function y(r,t,e,s){return!e||!s?!1:r!==e?!0:t!==s&&(s==="FIRST_TEST"||s==="RETEST")}function k(r){return{WAITING:"FIRST_TEST",FIRST_TEST:"REVIEW",REVIEW:"RETEST",RETEST:"FINISHED",FINISHED:null}[r]??null}const d="kbs-study:v1";function h(r){if(!r)return null;try{return JSON.parse(r)}catch{return null}}class A{constructor(t=window.localStorage){this.storage=t}getSession(t){return h(this.storage.getItem(`${d}:session:${t}`))}createSession(t,e){const s={roundId:t,participantId:crypto.randomUUID(),nickname:e.trim()};return this.storage.setItem(`${d}:session:${t}`,JSON.stringify(s)),s}updateNickname(t,e){const s={...t,nickname:e.trim()};return this.storage.setItem(`${d}:session:${t.roundId}`,JSON.stringify(s)),s}getAnswers(t,e,s){return h(this.storage.getItem(`${d}:answers:${t}:${e}:${s}`))??{}}saveAnswer(t,e,s,n,i){const o=this.getAnswers(t,e,s);return o[n]=i.slice(0,200),this.storage.setItem(`${d}:answers:${t}:${e}:${s}`,JSON.stringify(o)),o}getRetestOrder(t,e){return h(this.storage.getItem(`${d}:order:${t}:${e}:2`))}saveRetestOrder(t,e,s){this.storage.setItem(`${d}:order:${t}:${e}:2`,JSON.stringify(s))}getSubmissionState(t,e,s){const n=this.storage.getItem(`${d}:submission:${t}:${e}:${s}`);return n==="pending"||n==="submitted"?n:null}setSubmissionState(t,e,s,n){this.storage.setItem(`${d}:submission:${t}:${e}:${s}`,n)}}const D=4e3,w=1200,l="kbs-study:admin-token";function a(r){return String(r??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function p(r){if(!r)return"";const t=new Date(r);return Number.isNaN(t.getTime())?r:new Intl.DateTimeFormat("ko-KR",{year:"numeric",month:"numeric",day:"numeric"}).format(t)}function m(){return(window.location.hash||"#/exam").replace(/^#\/?/,"").split("/").filter(Boolean)}function g(r){return{WAITING:"시험 준비",FIRST_TEST:"1차 시험",REVIEW:"정답 확인",RETEST:"재시험",FINISHED:"시험 완료"}[r]}class x{constructor(t){this.root=t}api=new S("https://script.google.com/macros/s/AKfycbydwBqH1ZXSq9LirFb8_qORLSm6MHDzvZW718NDff4La3A2PYdAFzhbx2lNzxm0Fmd-/exec".trim()??"");storage=new A;bootstrapData=null;historyData=[];detailData=null;session=null;loading=!0;refreshing=!1;message="";currentQuestionIndex=0;editingNickname=!1;submittingAttempt=null;retryTimer=null;pollTimer=null;retryDelayIndex=0;openExplanations=new Set;pendingTransition=null;pendingAction=null;pendingNickname="";pendingRoundTitle="";slowRequest=!1;slowBackgroundRefresh=!1;slowRequestTimer=null;slowBackgroundTimer=null;queuedForegroundLoad=!1;async start(){window.addEventListener("hashchange",()=>void this.loadRoute()),window.addEventListener("online",()=>void this.loadRoute(!0)),document.addEventListener("visibilitychange",()=>{document.visibilityState==="visible"&&this.loadRoute(!0)}),this.root.addEventListener("click",t=>void this.handleClick(t)),this.root.addEventListener("submit",t=>void this.handleSubmit(t)),this.root.addEventListener("input",t=>this.handleInput(t)),this.root.addEventListener("change",t=>this.handleChange(t)),await this.loadRoute()}async loadRoute(t=!1){if(this.refreshing){t||(this.queuedForegroundLoad=!0,this.loading=!0,this.armSlowRequestTimer(),this.render());return}const e=t?this.getBackgroundRenderSnapshot():"";this.refreshing=!0,t?this.pendingAction||this.armSlowBackgroundTimer():(this.loading=!0,this.armSlowRequestTimer(),this.render()),this.clearPolling();try{const[s,n]=m();!s||s==="exam"?(await this.loadExam(),this.startPolling()):s==="history"&&n?this.detailData=await this.api.roundDetail(n):s==="history"?this.historyData=await this.api.history():s==="admin"?(await this.loadExam(!1),this.startPolling()):window.location.hash="#/exam",t&&(this.message="")}catch(s){this.message=this.friendlyError(s)}finally{if(this.loading=!1,this.refreshing=!1,t||this.clearSlowRequestTimer(),this.clearSlowBackgroundTimer(),this.queuedForegroundLoad){this.queuedForegroundLoad=!1,await this.loadRoute();return}(!t||e!==this.getBackgroundRenderSnapshot())&&this.render()}}getBackgroundRenderSnapshot(){return JSON.stringify({bootstrapData:this.bootstrapData,historyData:this.historyData,detailData:this.detailData,session:this.session,message:this.message,submittingAttempt:this.submittingAttempt})}async loadExam(t=!0){const e=this.bootstrapData?.currentRound,s=this.session??(e?this.storage.getSession(e.roundId):null),n=await this.api.bootstrap(s?.participantId),i=n.currentRound?.roundId;this.session=i?this.storage.getSession(i):null,this.bootstrapData=this.session&&this.session.participantId!==s?.participantId?await this.api.bootstrap(this.session.participantId):n,y(e?.roundId,e?.status,this.bootstrapData.currentRound?.roundId,this.bootstrapData.currentRound?.status)&&(this.currentQuestionIndex=0),t&&await this.handlePhaseSubmission()}armSlowRequestTimer(){this.clearSlowRequestTimer(),this.slowRequest=!1,this.slowRequestTimer=window.setTimeout(()=>{this.slowRequest=!0,this.render()},w)}clearSlowRequestTimer(){this.slowRequestTimer!==null&&window.clearTimeout(this.slowRequestTimer),this.slowRequestTimer=null,this.slowRequest=!1}armSlowBackgroundTimer(){this.clearSlowBackgroundTimer(),this.slowBackgroundTimer=window.setTimeout(()=>{this.slowBackgroundRefresh=!0,this.updateConnectionFeedback()},w)}clearSlowBackgroundTimer(){this.slowBackgroundTimer!==null&&window.clearTimeout(this.slowBackgroundTimer),this.slowBackgroundTimer=null,this.slowBackgroundRefresh=!1,this.updateConnectionFeedback()}beginAction(t){return this.pendingAction?!1:(this.pendingAction=t,this.clearPolling(),this.armSlowRequestTimer(),this.render(),!0)}finishAction(){const t=this.pendingAction;this.pendingAction=null,t==="nickname"&&(this.pendingNickname=""),t==="next-round"&&(this.pendingRoundTitle=""),this.clearSlowRequestTimer(),this.render();const[e]=m();(!e||e==="exam"||e==="admin")&&this.startPolling()}async handlePhaseSubmission(){const t=this.bootstrapData,e=t?.currentRound;!t||!e||!this.session||(e.status==="REVIEW"?await this.ensureSubmitted(1):e.status==="FINISHED"&&t.eligibleForRetest&&await this.ensureSubmitted(2))}async ensureSubmitted(t){if(!this.session||!this.bootstrapData?.currentRound)return;const{roundId:e}=this.bootstrapData.currentRound;if(this.storage.getSubmissionState(e,this.session.participantId,t)!=="submitted"){this.storage.setSubmissionState(e,this.session.participantId,t,"pending"),this.submittingAttempt=t,this.render();try{const s=this.storage.getAnswers(e,this.session.participantId,t);await this.api.submitAttempt({roundId:e,participantId:this.session.participantId,nickname:this.session.nickname,attempt:t,answers:Object.entries(s).map(([n,i])=>({questionId:n,response:i}))}),this.storage.setSubmissionState(e,this.session.participantId,t,"submitted"),this.retryDelayIndex=0,this.message="",this.bootstrapData=await this.api.bootstrap(this.session.participantId)}catch(s){this.message=this.friendlyError(s,"답안을 아직 보내지 못했어요. 연결되는 대로 다시 제출할게요."),this.scheduleRetry()}finally{this.submittingAttempt=null}}}scheduleRetry(){this.retryTimer!==null&&window.clearTimeout(this.retryTimer);const t=[5e3,1e4,2e4,3e4],e=t[Math.min(this.retryDelayIndex,t.length-1)];this.retryDelayIndex+=1,this.retryTimer=window.setTimeout(()=>void this.loadRoute(!0),e)}startPolling(){this.clearPolling(),this.pollTimer=window.setInterval(()=>void this.loadRoute(!0),D)}clearPolling(){this.pollTimer!==null&&window.clearInterval(this.pollTimer),this.pollTimer=null}friendlyError(t,e="연결이 잠시 불안정해요. 잠시 후 다시 시도해볼게요."){return t instanceof u&&t.message||e}render(){const[t,e]=m(),s=(t==="exam"||!t)&&["FIRST_TEST","RETEST"].includes(this.bootstrapData?.currentRound?.status??""),n=this.loading?this.renderLoading():t==="history"&&e?this.renderRoundDetail():t==="history"?this.renderHistory():t==="admin"?this.renderAdmin():this.renderExam();this.root.innerHTML=`
    ...
    `,this.syncIndeterminateCheckbox(),this.updateConnectionFeedback()}renderRequestFeedback(){const t=this.pendingAction==="nickname"?"참가 준비는 끝났어요. 최신 시험 상태를 확인하고 있어요.":this.pendingAction==="transition"?"화면을 다음 시험 단계로 먼저 바꿨어요. Google에 저장하고 있어요.":this.pendingAction==="next-round"?"새 회차를 화면에 먼저 준비했어요. Google에 저장하고 있어요.":"";return t?`<div class="request-feedback" role="status"><span class="spinner" aria-hidden="true"></span><span>${t}</span></div>`:!this.slowRequest||this.loading&&!this.pendingAction?"":`<div class="request-feedback" role="status"><span class="spinner" aria-hidden="true"></span><span>${this.pendingAction==="admin-login"?"관리자 권한을 확인하고 있어요. Apps Script 응답이 평소보다 조금 늦어요.":this.pendingAction==="retry-submit"?"답안을 다시 보내고 있어요. 입력한 답은 이 기기에 안전하게 남아 있어요.":"시험 데이터를 불러오는 데 시간이 조금 걸리고 있어요. 연결은 유지되고 있습니다."}</span></div>`}updateConnectionFeedback(){const t=this.root.querySelector(".connection-feedback");t&&(t.hidden=!this.slowBackgroundRefresh,t.textContent=this.slowBackgroundRefresh?"최신 시험 상태 확인이 늦어지고 있어요. 입력한 답은 이 기기에 계속 저장됩니다.":"")}renderNavigation(t){const e=(s,n,i)=>`<a href="${s}" class="nav__link ${i?"is-active":""}">${n}</a>`;return`
    ...
    `}renderAdmin(){if(!sessionStorage.getItem(l)){const o=this.pendingAction==="admin-login";return`
      ...
      `}const e=this.bootstrapData?.currentRound;if(!e)return this.renderEmpty("관리할 회차가 없어요","시트에서 새 회차를 준비해주세요.");const s=k(e.status),n=this.pendingAction==="transition"||this.pendingAction==="next-round",i={WAITING:"1차 시험 시작",FIRST_TEST:"1차 시험 종료",REVIEW:"재시험 시작",RETEST:"재시험 종료",FINISHED:""};return`
      <section class="narrow-panel admin-panel">
        <p class="eyebrow">현재 회차</p>
        <h1>${a(e.title)}</h1>
        <p class="lead">현재 ${g(e.status)} 단계예요.</p>
        ${n?"":s?`<button class="button button--primary" data-action="prepare-transition" data-target="${s}" type="button">${i[e.status]}</button>`:this.renderNextRoundForm()}
    ...
    `}renderEmpty(t,e){return`<section class="status-screen"><h1>${a(t)}</h1><p>${a(e)}</p></section>`}async handleClick(t){const e=t.target.closest("[data-action]");if(!e)return;const s=e.dataset.action;if(s==="edit-nickname")this.editingNickname=!0,this.render();else if(s==="previous-question")this.currentQuestionIndex=Math.max(0,this.currentQuestionIndex-1),this.renderAndFocusAnswer();else if(s==="next-question")this.currentQuestionIndex+=1,this.renderAndFocusAnswer();else if(s==="retry-submit"){if(!this.beginAction("retry-submit"))return;try{await this.handlePhaseSubmission()}finally{this.finishAction()}}else if(s==="prepare-transition")this.pendingTransition=e.dataset.target,this.render();else if(s==="cancel-transition")this.pendingTransition=null,this.render();else if(s==="confirm-transition"){if(!this.beginAction("transition"))return;try{await this.performTransition(e.dataset.target)}finally{this.finishAction()}}else s==="admin-logout"&&(sessionStorage.removeItem(l),this.pendingTransition=null,this.render())}async handleSubmit(t){const e=t.target;if(!e.dataset.form)return;t.preventDefault();const s=new FormData(e);if(e.dataset.form==="nickname"){const n=String(s.get("nickname")??"").trim();if(!n||n.length>20||!this.bootstrapData?.currentRound)return;if(this.pendingNickname=n,!this.beginAction("nickname")){this.pendingNickname="";return}try{this.session=this.session?this.storage.updateNickname(this.session,n):this.storage.createSession(this.bootstrapData.currentRound.roundId,n),this.editingNickname=!1,this.message="",this.render(),await this.loadRoute(!0)}finally{this.finishAction()}}else if(e.dataset.form==="admin-login"){const n=String(s.get("code")??"");if(!this.beginAction("admin-login"))return;try{const i=await this.api.adminLogin(n);sessionStorage.setItem(l,i.adminToken),this.message=""}catch(i){this.message=this.friendlyError(i,"관리자 코드를 확인해주세요.")}finally{this.finishAction()}}else if(e.dataset.form==="next-round"){const n=String(s.get("title")??"").trim(),i=sessionStorage.getItem(l);if(!n||n.length>80||!i)return;if(this.pendingRoundTitle=n,!this.beginAction("next-round")){this.pendingRoundTitle="";return}const o=this.bootstrapData,c=this.session,$=this.currentQuestionIndex;this.bootstrapData={currentRound:{roundId:"pending-next-round",title:n,status:"WAITING",date:new Date().toISOString(),questionCount:20},questions:[],eligibleForRetest:!1},this.session=null,this.currentQuestionIndex=0,this.pendingTransition=null,this.message="",this.render();try{this.bootstrapData=await this.api.createNextRound(n,i),this.message="다음 회차가 준비됐어요. 참가자가 대기한 뒤 1차 시험을 시작해주세요."}catch(f){this.bootstrapData=o,this.session=c,this.currentQuestionIndex=$;const b=f;(b.code==="ADMIN_TOKEN_INVALID"||b.code==="ADMIN_TOKEN_EXPIRED")&&sessionStorage.removeItem(l),this.message=this.friendlyError(f)}finally{this.finishAction()}}}handleInput(t){const e=t.target,s=e.dataset.answer,n=this.bootstrapData?.currentRound;if(!s||!n||!this.session)return;const i=n.status==="RETEST"?2:1;this.storage.saveAnswer(n.roundId,this.session.participantId,i,s,e.value)}handleChange(t){const e=t.target;if(e.dataset.action==="toggle-all"&&this.detailData){this.openExplanations=e.checked?new Set(this.detailData.questions.map(n=>n.questionId)):new Set,this.render();return}const s=e.dataset.explanation;s&&(e.checked?this.openExplanations.add(s):this.openExplanations.delete(s),this.render())}async performTransition(t){const e=this.bootstrapData,s=e?.currentRound,n=sessionStorage.getItem(l);if(!(!s||!n)){this.bootstrapData={...e,currentRound:{...s,status:t}},this.pendingTransition=null,this.message="",this.render();try{const i=await this.api.transition(s.roundId,t,n);y(s.roundId,s.status,i.currentRound?.roundId,i.currentRound?.status)&&(this.currentQuestionIndex=0),this.bootstrapData=i,this.pendingTransition=null,this.message=""}catch(i){this.bootstrapData=e,this.pendingTransition=t;const o=i;(o.code==="ADMIN_TOKEN_INVALID"||o.code==="ADMIN_TOKEN_EXPIRED")&&sessionStorage.removeItem(l),this.message=this.friendlyError(i)}}}renderAndFocusAnswer(){this.render(),window.requestAnimationFrame(()=>document.querySelector("#answer")?.focus())}syncIndeterminateCheckbox(){if(!this.detailData)return;const t=this.root.querySelector('input[data-action="toggle-all"]');t&&(t.indeterminate=this.openExplanations.size>0&&this.openExplanations.size<this.detailData.questions.length)}}const I=document.querySelector("#app");if(!I)throw new Error("앱을 표시할 영역을 찾지 못했습니다.");const q=new x(I);q.start();
//# sourceMappingURL=index-D3LXTGYp.js.map
